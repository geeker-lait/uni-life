...
//
//                Map<EntityInfo,List<FieldInfo>> entityFieldsMap = new HashMap<>();
//
//
...
//
//                            List<FieldInfo> fieldInfos1 = entityFieldsMap.get(entityInfo);
//                            if(fieldInfos1 == null){
//                                entityInfo = new EntityInfo();
//                                String val = getMergedRegionValue(sheet, i, j);
//                                entityInfo.setClassName(val.substring(val.lastIndexOf("/")));
...
//
//                            String cv = getCellValue(row.getCell(j));
//                            switch (headName.substring(headName.lastIndexOf("/") + 1)) {
//                                case "Column":
//                                    fieldInfo.setColumnName(cv);
//                                    break;
//                                case "Type":
//                                    break;
//                                case "Null":
//                                    fieldInfo.setName(cv);
//                                    break;
//                                case "Default":
//                                    break;
//                                case "Comment":
//                                    fieldInfo.setComment(cv);
//                                    break;
//
//                            }

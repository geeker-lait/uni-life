...
import com.uni.service.rbac.service.RbacMenuService;

/**
 * controller for RbacMenu
 * 这是类的注释
 *
 * @author lait
...
public class RbacMenuController extends BaseEndpoint {
     ...
     * 新增
     *
     * @param rbacMenuRequestDto
     * @return
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody RbacMenuRequestDto rbacMenuRequestDto) {
        RbacMenuResponseDto rbacMenuResp = rbacMenuService.create(rbacMenuRequestDto);
        return super.doResource(rbacMenuResp, this.getClass());
    }
    ...
    public ResponseDto<?> delete(@PathVariable List<Long> ids) {
        rbacMenuService.deleteByIds(ids);
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody RbacMenuRequestDto rbacMenuRequestDto) {
        RbacMenuResponseDto rbacMenuResp = rbacMenuService.update(id,rbacMenuRequestDto);
        return super.doResource(rbacMenuResp, this.getClass());
    }
    ...
    public ResponseEntity<?> details(@PathVariable Long id) {
        RbacMenuResponseDto rbacMenuResp = rbacMenuService.details(id);
        return super.doResource(rbacMenuResp, this.getClass());
    }
    ...
    public HttpEntity<PagedModel<?>> getPageData(
        ...
        Page<RbacMenuResponseDto> page = rbacMenuService.getPageList(searchParams, pageInfo);
    ...
    public ResponseEntity<?> findByParams(
        ...
        Map<String, Object> searchParams = super.getSearchParamStartWith(request, IConstants.EMPTY_SEARCH_PREFIX);
        // 2.获取数据
        List<RbacMenuResponseDto> dataList = rbacMenuService.findByParams(searchParams,sortTypes);

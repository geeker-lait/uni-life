 ...
 */
@RestController
@RequestMapping("/rbacRoleResource")
public class RbacRoleResourceController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody RbacRoleResourceRequestDto rbacRoleResourceRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody RbacRoleResourceRequestDto rbacRoleResourceRequestDto) {

...
public class RbacRolePermissionController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody RbacRolePermissionRequestDto rbacRolePermissionRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody RbacRolePermissionRequestDto rbacRolePermissionRequestDto) {

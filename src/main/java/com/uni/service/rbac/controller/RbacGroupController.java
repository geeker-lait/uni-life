...
public class RbacGroupController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody RbacGroupRequestDto rbacGroupRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody RbacGroupRequestDto rbacGroupRequestDto) {

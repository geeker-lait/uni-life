...
public class RbacResourceController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody RbacResourceRequestDto rbacResourceRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody RbacResourceRequestDto rbacResourceRequestDto) {

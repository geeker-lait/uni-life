package com.uni.service.product.controller;
...
public class ProductCategoryController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody ProductCategoryRequestDto productCategoryRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody ProductCategoryRequestDto productCategoryRequestDto) {

 ...
 */
@RestController
@RequestMapping("/tHotspots")
public class THotspotsController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody THotspotsRequestDto tHotspotsRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody THotspotsRequestDto tHotspotsRequestDto) {

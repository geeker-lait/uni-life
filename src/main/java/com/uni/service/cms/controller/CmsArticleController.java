...
public class CmsArticleController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody CmsArticleRequestDto cmsArticleRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody CmsArticleRequestDto cmsArticleRequestDto) {

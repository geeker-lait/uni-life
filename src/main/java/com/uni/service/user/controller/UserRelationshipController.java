...
public class UserRelationshipController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody UserRelationshipRequestDto userRelationshipRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody UserRelationshipRequestDto userRelationshipRequestDto) {

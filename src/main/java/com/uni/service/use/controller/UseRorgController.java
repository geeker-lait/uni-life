package com.uni.service.use.controller;
...
public class UseRorgController extends BaseEndpoint {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody UseRorgRequestDto useRorgRequestDto) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody UseRorgRequestDto useRorgRequestDto) {
